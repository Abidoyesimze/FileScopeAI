      ...
      <div className="p-6 pb-4">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="text-center">
            <div className="text-lg font-bold text-gray-900 dark:text-white">{dataset.analysis.anomalies}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">Anomalies</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-gray-900 dark:text-white">{dataset.analysis.biasScore}%</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">Bias</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-gray-900 dark:text-white">{dataset.analysis.completeness}%</div>
